...
export const FavoritePreviewWrapper = styled.div`     
    //border: 1px solid red;      
    display: flex;
    justify-content: center;         
`

export const FavoritePreviewWrapper_Global_DOS = styled.div`
...
export const FavoritePreviewGalleryWrapper = styled.div`        
   flex: 30;
   justify-content: center;
   margin: 5px;
   img{ 
...
`
export const FavoritePreviewInfoWrapper = styled.div`    
    //border: 1px solid red;
    flex: 70;
    padding-left:10px;
